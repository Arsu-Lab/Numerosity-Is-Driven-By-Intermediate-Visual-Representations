def _load_image_metadata_numerosity_background_change(total_data: list[tuple]):
    """"""
    total_counts = []
...
def _calculate_targets_numerosity_background_change(image_metadata: list[tuple]):
    """"""
    total_actions = []
    total_action_sizes = []
