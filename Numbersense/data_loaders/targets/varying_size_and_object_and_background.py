def _load_image_metadata_varying_size_and_object_and_background(total_data: list[tuple]):
    """"""
    total_counts = []
...
def _calculate_targets_varying_size_and_object_and_background(image_metadata: list[tuple]):
    """"""
    total_actions = []
    total_action_sizes = []
